...
UIGui.Name = "OrionToggle"
UIGui.Parent = game.CoreGui

ToggleButton.Name = "ToggleButton"
ToggleButton.Parent = UIGui
ToggleButton.Size = UDim2.new(0, 32, 0, 32)
ToggleButton.Position = UDim2.new(0, 105, 0, -32)
ToggleButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
ToggleButton.BackgroundTransparency = 0.5
ToggleButton.Text = "X"
ToggleButton.TextColor3 = Color3.fromRGB(200, 200, 200)
ToggleButton.Font = 'Code'
ToggleButton.TextSize = 20
ToggleButton.Draggable = false
ToggleButton.MouseButton1Click:Connect(function()
if game.CoreGui.XAOrion.Enabled == true then
game.CoreGui.XAOrion.Enabled = false
else
game.CoreGui.XAOrion.Enabled = true
end
end)
...
function OrionLib:MakeWindow(WindowConfig)
        ...
        AddConnection(CloseBtn.MouseButton1Up, function()
                ...
                NotificationBindable.OnInvoke = function(bText)
                    if bText == "是" then
